  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du livre n°${livre.getId()}</h5> <!-- TODO : afficher l'id du livre au lieu de 42 -->
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer le livre ${livre.getTitre()} de ${livre.getAuteur()} (code ${livre.getIsbn()}) ?</p> <!-- TODO : compléter les trois informations ci-contre -->
	      <form action="dashboard" method="post" class="col s12">
