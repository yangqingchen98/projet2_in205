    ...
    <section class="content">
      ...
      <h5>Suppression du membre n°${membre.getId()}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
	      ...
	      <form action="/TP3Ensta/dashboard" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/TP3Ensta/membre_details?id=idDuMembre">Annuler</a> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        </div>
	      </form>
	    </div>	    
      </div>
