                ...
                <tbody>
                 <% 
                	...
                	<tr>
                        ...
                        <td><%=l.getAuteur()%></td>
                        <td><%=l.getIsbn()%></td>
                        <td class="center"><a href="livre_details?id=<%=l.getId() %>"><ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
                        <td class="center"><a href="livre_delete?id=<%=l.getId() %>"><ion-icon class="delete" name="information-circle-outline"></ion-icon></a></td>
                    </tr>
